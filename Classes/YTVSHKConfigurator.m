//
//  YTVSHKConfigurator.m
//  YouTubeViewer
//
//  Created by Billy Shih on 5/23/12.
//  Copyright (c) 2012 __MyCompanyName__. All rights reserved.
//

#import "YTVSHKConfigurator.h"

@implementation YTVSHKConfigurator
/* 
 App Description 
 ---------------
 ...
 */
- (NSString*)appName {
	return @"One More Corgi";
}

- (NSString*)appURL {
	return @"http://mightyodin.com";
}
...
- (NSString*)twitterConsumerKey {
	return @"6nGKOb3U4nU4d2Erjv0n4A";
}

- (NSString*)twitterSecret {
	return @"dcoXuybTOIchiiYtF2DGq0TxKbWumwcXwHXPpvgg";
}
// You need to set this if using OAuth, see note above (xAuth users can skip it)
- (NSString*)twitterCallbackUrl {
	return @"http://bstandards.com";
}
