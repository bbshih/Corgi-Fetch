...
@property BOOL hasMovedToOtherView;
...
@property (nonatomic,readonly) UIScrollView* thumbsView;
...
@property NSInteger thumbnailSize;
@property NSInteger thumbnailsSpacingSize;
